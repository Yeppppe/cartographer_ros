...
TRAJECTORY_BUILDER_2D = {
  ...
  -- 计算复杂度高 , 但是很鲁棒 , 在odom或者imu不准时依然能达到很好的效果 ，适合在使用单线雷达，发布频率不是很高的时候设置为true，建图效果会很好
  ...
  -- 子图相关的一些配置
  submaps = {
    num_range_data = 90,          -- 一个子图里插入雷达数据的个数的一半 相当于一个子图里面最多插入180个点云数据
    grid_options_2d = {
